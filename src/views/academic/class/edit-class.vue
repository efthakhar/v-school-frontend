...
export default{
    ...
    methods:{
        ...
        editClass(id){
            axios.put(`${this.api_url}/api/classes/${id}`, this.class_data)
                .then((response) => {
...
<template>
    <div class="page-view">
        ...
        <div class="page-top-nav">
            <h4 class="blue-txt">edit class</h4>
        </div>
        <div class="page-main-content">
             <form action="" class="row mb-2">
                ...
                <div class="form_item col-md-10">
                    <a class="btn btn-primary my-3" @click="editClass(class_data.id)">Submit class data</a>
                </div>
